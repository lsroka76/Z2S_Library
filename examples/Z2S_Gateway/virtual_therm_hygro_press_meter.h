...
#ifndef SRC_SUPLA_SENSOR_VIRTUAL_THERM_HYGRO_PRESS_METER_H_
#define SRC_SUPLA_SENSOR_VIRTUAL_THERM_HYGRO_PRESS_METER_H_

#include <supla/sensor/therm_hygro_press_meter.h>

namespace Supla {
namespace Sensor {
class VirtualThermHygroPressMeter : public ThermHygroPressMeter {
 public:
...
#endif  // SRC_SUPLA_SENSOR_VIRTUAL_THERM_HYGRO_PRESS_METER_H_
