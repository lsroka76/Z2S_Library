...
static constexpr zigbee_datatype_t zigbee_datatypes[] PROGMEM = 
   ...
   { .zigbee_datatype_name = "U48",			
	 ...
	 { .zigbee_datatype_name = "SINGLE (FLOAT)",		
	   .zigbee_datatype_size = 0x04,	
		 .zigbee_datatype_id = ESP_ZB_ZCL_ATTR_TYPE_SINGLE },
...
//POWER CONFIG
  ...
  //ON OFF
	...
	{
		.zigbee_attribute_id  = 0x8000, 
	  .zigbee_attribute_cluster_id = ESP_ZB_ZCL_CLUSTER_ID_ON_OFF, 
		.zigbee_attribute_datatype_id = ESP_ZB_ZCL_ATTR_TYPE_BOOL,
		.zigbee_attribute_name = "TUYA CHILD LOCK"
	},
	{
  ...
  //ELECTRICAL MESUREMENT
	...
	{ .zigbee_attribute_id  = LUMI_CUSTOM_POWER_ON_BEHAVIOR_ID, 
		.zigbee_attribute_cluster_id = LUMI_CUSTOM_CLUSTER, 
		.zigbee_attribute_datatype_id = ESP_ZB_ZCL_ATTR_TYPE_U8,
		.zigbee_attribute_name = "POWER ON BEHAVIOR" },

	{ .zigbee_attribute_id  = LUMI_CUSTOM_OVERLOAD_PROTECTION_ID, 
		.zigbee_attribute_cluster_id = LUMI_CUSTOM_CLUSTER, 
		.zigbee_attribute_datatype_id = ESP_ZB_ZCL_ATTR_TYPE_SINGLE,
		.zigbee_attribute_name = "OVERLOAD PROTECTION (100 - 3840W)" },

	{ .zigbee_attribute_id  = LUMI_CUSTOM_LED_INDICATOR_ID, 
		.zigbee_attribute_cluster_id = LUMI_CUSTOM_CLUSTER, 
		.zigbee_attribute_datatype_id = ESP_ZB_ZCL_ATTR_TYPE_BOOL,
		.zigbee_attribute_name = "LED INDICATOR" },

	{ .zigbee_attribute_id  = LUMI_CUSTOM_CHARGING_PROTECTION_ID, 
		.zigbee_attribute_cluster_id = LUMI_CUSTOM_CLUSTER, 
		.zigbee_attribute_datatype_id = ESP_ZB_ZCL_ATTR_TYPE_BOOL,
		.zigbee_attribute_name = "CHARGING PROTECTION" },
...
static constexpr zigbee_attribute_value_t zigbee_attribute_values [] PROGMEM = {
	...
	},
	{
		.zigbee_attribute_id = LUMI_CUSTOM_POWER_ON_BEHAVIOR_ID,
		.zigbee_cluster_id = LUMI_CUSTOM_CLUSTER,
		.zigbee_attribute_value_name = "INVERTED",
		.zigbee_attribute_value = 0x03
	},
	{
		.zigbee_attribute_id = LUMI_CUSTOM_LED_INDICATOR_ID,
...
static const Tuya_datapoint_desc_t Tuya_datapoints[] PROGMEM = {
  ...
  { .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_PIR_ILLUMINANCE_SENSOR,
    ...
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_3F_TEMPERATURE_UNIT_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_ENUM,
	...
	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_SOIL_SENSOR_3F,
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_3F_TEMPERATURE_CALIBRATION_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
	...
	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_SOIL_SENSOR_3F,
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_3F_HUMIDITY_CALIBRATION_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Humidity calibration",
    .Tuya_datapoint_description = "Enter numeric value between -30% and 30%" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_SOIL_SENSOR_3F,
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_3F_SOIL_CALIBRATION_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Soil moisture calibration",
    .Tuya_datapoint_description = "Enter numeric value between -30% and 30%" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_SOIL_SENSOR_3F,
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_3F_TEMPERATURE_SAMPLING_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Air T/H sampling interval",
    .Tuya_datapoint_description = "Enter numeric value between 5 and 3600 [s]" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_SOIL_SENSOR_3F,
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_3F_SOIL_SAMPLING_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Soil moisture sampling interval",
    .Tuya_datapoint_description = "Enter numeric value between 5 and 3600 [s]" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_SOIL_SENSOR_3F,
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_3F_SOIL_WARNING_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    ...
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_4F_TEMPERATURE_CALIBRATION_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Temperature calibration",
    .Tuya_datapoint_description = "Enter numeric value between -20 and 20: <br>"
																	"1 = 0.1°C" },
	...
	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_SOIL_SENSOR_4F,
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_4F_HUMIDITY_CALIBRATION_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Humidity calibration",
    .Tuya_datapoint_description = "Enter numeric value between -30% and 30%" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_SOIL_SENSOR_4F,
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_4F_SOIL_CALIBRATION_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Soil moisture calibration",
    .Tuya_datapoint_description = "Enter numeric value between -30% and 30%" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_SOIL_SENSOR_4F,
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_4F_ILLUMINANCE_CALIBRATION_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Illuminance calibration",
    .Tuya_datapoint_description = "Enter numeric value between -1000 lx and 1000 lx" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_SOIL_SENSOR_4F,
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_4F_SOIL_SAMPLING_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Soil moisture sampling interval",
    .Tuya_datapoint_description = "Enter numeric value between 5 and 3600 [s]" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_SOIL_SENSOR_4F,
    .Tuya_datapoint_id 		 			= TUYA_SOIL_SENSOR_4F_SOIL_WARNING_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Soil moisture alarm value",
    .Tuya_datapoint_description = "Enter numeric value between 0 and 100 [%]" },
  ...
  { .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_TEMPHUMIDITY_EF00_SENSOR_1,
    .Tuya_datapoint_id 		 			= TUYA_TH_SENSOR_TEMPERATURE_REPORT_INTERVAL_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Temperature reporting interval",
    .Tuya_datapoint_description = "Enter numeric value between 1 and 120 [min]" },

  { .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_TEMPHUMIDITY_EF00_SENSOR_1,
    .Tuya_datapoint_id 		 			= TUYA_TH_SENSOR_HUMIDITY_REPORT_INTERVAL_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Humidity reporting interval",
    .Tuya_datapoint_description = "Enter numeric value between 1 and 120 [min]" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_TEMPHUMIDITY_EF00_SENSOR_1,
    .Tuya_datapoint_id 		 			= TUYA_TH_SENSOR_TEMPERATURE_SENSITIVITY_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Temperature sensitivity",
    .Tuya_datapoint_description = "Enter numeric value between 3 and 10<br>"
																	"1 = 0.1°C" },
  ...
  { .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_TEMPHUMIDITY_EF00_SENSOR_1,
    .Tuya_datapoint_id 		 			= TUYA_TH_SENSOR_HUMIDITY_SENSITIVITY_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
  ...
  { .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_TEMPHUMIDITY_EF00_SENSOR_4,
    ...
    .Tuya_datapoint_id 		 			= TUYA_PRESENCE_SENSOR_ZG205ZA_LM_DETECTION_SENSITIVITY_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Large motion detection sensitivity",
    .Tuya_datapoint_description = "Enter numeric value: 0 - 10" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_PRESENCE_SENSOR_ZG205ZA,
    .Tuya_datapoint_id 		 			= TUYA_PRESENCE_SENSOR_ZG205ZA_LM_DETECTION_DISTANCE_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Large motion detection distance",
    .Tuya_datapoint_description = "Enter numeric value: 0 - 1000 [cm]" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_PRESENCE_SENSOR_ZG205ZA,
    .Tuya_datapoint_id 		 			= TUYA_PRESENCE_SENSOR_ZG205ZA_MM_DETECTION_SENSITIVITY_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Medium motion detection sensitivity",
    .Tuya_datapoint_description = "Enter numeric value: 0 - 10" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_PRESENCE_SENSOR_ZG205ZA,
    .Tuya_datapoint_id 		 			= TUYA_PRESENCE_SENSOR_ZG205ZA_MM_DETECTION_DISTANCE_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Medium motion detection distance",
    .Tuya_datapoint_description = "Enter numeric value: 0 - 600 [cm]" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_PRESENCE_SENSOR_ZG205ZA,
    .Tuya_datapoint_id 		 			= TUYA_PRESENCE_SENSOR_ZG205ZA_SM_DETECTION_SENSITIVITY_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Small motion detection sensitivity",
    .Tuya_datapoint_description = "Enter numeric value: 0 - 10" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_PRESENCE_SENSOR_ZG205ZA,
    .Tuya_datapoint_id 		 			= TUYA_PRESENCE_SENSOR_ZG205ZA_SM_DETECTION_DISTANCE_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Small motion detection distance",
    .Tuya_datapoint_description = "Enter numeric value: 0 - 600 [cm]" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_PRESENCE_SENSOR_ZG205ZA,
    .Tuya_datapoint_id 		 			= TUYA_PRESENCE_SENSOR_ZG205ZA_FADING_TIME_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Fading time",
    .Tuya_datapoint_description = "Enter numeric value: 0 - 28800 [s]" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_PRESENCE_SENSOR_ZG205ZA,
    .Tuya_datapoint_id 		 			= TUYA_PRESENCE_SENSOR_ZG205ZA_MINIMUM_RANGE_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_VALUE,
    .Tuya_datapoint_name 	 			= "Minimum range",
    .Tuya_datapoint_description = "Enter numeric value: 0 - 600 [cm]" },

	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TUYA_PRESENCE_SENSOR_ZG205ZA,
    .Tuya_datapoint_id 		 			= TUYA_PRESENCE_SENSOR_ZG205ZA_INDICATOR_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_BOOL,
    .Tuya_datapoint_name 	 			= "LED indicator",
    .Tuya_datapoint_description = "Enter numeric value:<br>"
																	"0 => set indicator OFF<br>"
	...
	{ .z2s_device_desc_id 	 			= Z2S_DEVICE_DESC_TS0601_TRV_TRV602Z,
    .Tuya_datapoint_id 		 			= TUYA_TS0601_TRV_TRV602Z_FROST_PROTECTION_DP,
    .Tuya_datapoint_type 				= TUYA_DP_TYPE_BOOL,
