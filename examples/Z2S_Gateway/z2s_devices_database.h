...
#define Z2S_DEVICE_DESC_LUMI_RELAY_ELECTRICITY_METER        0x4460
...
#define LUMI_SMOKE_DETECTOR_SMOKE_SID                       0x00
#define LUMI_SMOKE_DETECTOR_SMOKE_DENSITY_SID               0x01
#define LUMI_SMOKE_DETECTOR_SMOKE_DENSITY_DBM_SID           0x02
#define LUMI_SMOKE_DETECTOR_SELFTEST_SID                    0x03
#define LUMI_SMOKE_DETECTOR_SELFTEST_STATE_SID              0x04
#define LUMI_SMOKE_DETECTOR_BUZZER_SID                      0x05
#define LUMI_SMOKE_DETECTOR_BUZZER_MANUAL_ALARM_SID         0x06
#define LUMI_SMOKE_DETECTOR_BUZZER_MANUAL_MUTE_SID          0x07
#define LUMI_SMOKE_DETECTOR_HEARTBEAT_INDICATOR_SID         0x08
#define LUMI_SMOKE_DETECTOR_LINKAGE_ALARM_SID               0x09
#define LUMI_SMOKE_DETECTOR_LINKAGE_ALARM_STATE_SID         0x0A
...
typedef struct z2s_device_endpoint_s {
  uint8_t endpoint_id;
  uint8_t reporting_flags;
  uint16_t z2s_reporting_set_id; 
  uint32_t z2s_device_desc_id;
} z2s_device_endpoint_t;

typedef struct z2s_reporting_set_desc_s {

  uint16_t z2s_reporting_set_id;
  uint16_t z2s_cluster_id;
  uint16_t z2s_attribute_id;
...
#define Z2S_REPORTING_SET_FLAG_STANDARD                                 0x10

#define Z2S_REPORTING_SET_DESC_TEMPERATURE_HUMIDITY_BASIC               0x0100
...
static const z2s_device_desc_t Z2S_DEVICES_DESC[] PROGMEM [[maybe_unused]] = {
  ...
  {	.z2s_device_desc_id = Z2S_DEVICE_DESC_LUMI_RELAY_ELECTRICITY_METER,
    .z2s_device_clusters_count = 1,
    .z2s_device_config_flags = Z2S_DEVICE_DESC_CONFIG_FLAG_LUMI_INIT,
    .z2s_device_clusters = { ESP_ZB_ZCL_CLUSTER_ID_ON_OFF }},
...
//DEVICES_START
  ...
  {	.manufacturer_name = "ZIBI", .model_name = "ESP32C6_T_Sensor_1CH",
    .z2s_device_uid = 11,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TEMPERATURE_SENSOR,
  ...
  {	.manufacturer_name = "ZIBI", .model_name = "ESP32C6_T_Sensor_2CH",
    .z2s_device_uid = 12,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TEMPERATURE_SENSOR,
    .z2s_device_flags = Z2S_DEVICE_CONFIG_FLAG_MIRROR_ALL_ENDPOINTS,
	  .z2s_device_endpoints_count = 2,
    ...
    {	.manufacturer_name = "ZIBI", .model_name = "ESP32C6_T_Sensor_3CH",
    .z2s_device_uid = 13,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TEMPERATURE_SENSOR,
    .z2s_device_flags = Z2S_DEVICE_CONFIG_FLAG_MIRROR_ALL_ENDPOINTS,
    ...
    {	.manufacturer_name = "ZIBI", .model_name = "ESP32C6_T_Sensor_4CH",
    .z2s_device_uid = 14,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TEMPERATURE_SENSOR,
    .z2s_device_flags = Z2S_DEVICE_CONFIG_FLAG_MIRROR_ALL_ENDPOINTS,
    ...
    {	.manufacturer_name = "ZIBI", .model_name = "ESP32C6_T_Sensor_5CH",
    .z2s_device_uid = 15,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TEMPERATURE_SENSOR,
    .z2s_device_flags = Z2S_DEVICE_CONFIG_FLAG_MIRROR_ALL_ENDPOINTS,
    ...
    {	.manufacturer_name = "ZIBI", .model_name = "ESP32C6_T_Sensor_6CH",
    .z2s_device_uid = 16,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TEMPERATURE_SENSOR,
    .z2s_device_flags = Z2S_DEVICE_CONFIG_FLAG_MIRROR_ALL_ENDPOINTS,
  ...
  {	.manufacturer_name = "ZIBI", .model_name = "ESP32C6_T_Sensor_7CH",
    .z2s_device_uid = 17,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TEMPERATURE_SENSOR,
    .z2s_device_flags = Z2S_DEVICE_CONFIG_FLAG_MIRROR_ALL_ENDPOINTS,
	  .z2s_device_endpoints_count = 7,
    .z2s_device_endpoints = {{10, 0, 0, Z2S_DEVICE_DESC_TEMPERATURE_SENSOR}}},

    {	.manufacturer_name = "ZIBI", .model_name = "ESP32C6_T_Sensor_8CH",
    .z2s_device_uid = 18,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TEMPERATURE_SENSOR,
    .z2s_device_flags = Z2S_DEVICE_CONFIG_FLAG_MIRROR_ALL_ENDPOINTS,
    ...
    {	.manufacturer_name = "ZIBI", .model_name = "ESP32C6_T_Sensor_9CH",
    .z2s_device_uid = 19,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TEMPERATURE_SENSOR,
    .z2s_device_flags = Z2S_DEVICE_CONFIG_FLAG_MIRROR_ALL_ENDPOINTS,
	  .z2s_device_endpoints_count = 9,
    .z2s_device_endpoints = {{10, 0, 0, Z2S_DEVICE_DESC_TEMPERATURE_SENSOR}}},

    {	.manufacturer_name = "ZIBI", .model_name = "ESP32C6_T_Sensor_10CH",
    .z2s_device_uid = 20,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TEMPERATURE_SENSOR,
    .z2s_device_flags = Z2S_DEVICE_CONFIG_FLAG_MIRROR_ALL_ENDPOINTS,
	  .z2s_device_endpoints_count = 10,
  ...
  {	.manufacturer_name = "Xiaomi", .model_name = "LYWSD03MMC-z",
    ...
    .z2s_device_endpoints = { 
      ...
      Z2S_REPORTING_SET_DESC_TEMPERATURE_HUMIDITY_XIAOMI, 
      Z2S_DEVICE_DESC_TEMPHUMIDITY_SENSOR_1}},
  ...
  {	.manufacturer_name = "_TZ3000_f2bw0b6k", .model_name = "TS0201",
    .z2s_device_uid = 3005,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_TEMPHUMIDITY_SENSOR,
	  .z2s_device_endpoints_count = 1},
 ...
 {	.manufacturer_name = "_TZE284_sgabhwa6", .model_name = "TS0601",
    .z2s_device_uid = 3605,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_SOIL_TEMPHUMIDITY_SENSOR,
	  .z2s_device_endpoints_count = 1},
  ...
  {	.manufacturer_name = "IKEA of Sweden", .model_name = "PARASOLL Door/Window Sensor",
    .z2s_device_uid = 5600,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = { { 1, 0, 0, Z2S_DEVICE_DESC_IKEA_IAS_ZONE_SENSOR_1},
                              { 2, 0, 0, Z2S_DEVICE_DESC_IKEA_IAS_ZONE_SENSOR_2 }}},
 ...
 {	.manufacturer_name = "HOBEIAN", .model_name = "ZG-223Z",
    .z2s_device_uid = 7805,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_RAIN_SENSOR_2,
	  .z2s_device_endpoints_count = 1},
  ...
  {	.manufacturer_name = "Develco Products A/S", .model_name = "SPLZB-132",
    .z2s_device_uid = 9400,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_DEVELCO_RELAY_ELECTRICITY_METER,
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {{ 2, 0, 0, Z2S_DEVICE_DESC_DEVELCO_RELAY_ELECTRICITY_METER },
  ...
  {	.manufacturer_name = "Develco Products A/S", .model_name = "AQSZB-110",
   .z2s_device_uid = 9500,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_DEVELCO_AIR_QUALITY_SENSOR,
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {{ 38, 0, 0, Z2S_DEVICE_DESC_DEVELCO_AIR_QUALITY_SENSOR },
                             { 1, 0, 0, Z2S_DEVICE_DESC_NULL }}},
  ...
  {	.manufacturer_name = "OSRAM", .model_name = "Plug 01",
    .z2s_device_uid = 10605,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_RELAY_1,
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {{ 3, 0, 0, Z2S_DEVICE_DESC_RELAY_1 },
                             { 1, 0, 0, Z2S_DEVICE_DESC_NULL }}},
  ...
  {	.manufacturer_name = "LUMI", .model_name = "lumi.switch.l2aeu1",
    .z2s_device_uid = 11205,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_LUMI_DOUBLE_SWITCH,
	  .z2s_device_endpoints_count = 2,
     .z2s_device_endpoints = {{ 1, 0, 0, Z2S_DEVICE_DESC_LUMI_DOUBLE_SWITCH },
                              { 2, 0, 0, Z2S_DEVICE_DESC_LUMI_DOUBLE_SWITCH }}},
  ...
  {	.manufacturer_name = "_TZ3210_cehuw1lw", .model_name = "TS011F",
    .z2s_device_uid = 11550,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_RELAY_1,
	  .z2s_device_endpoints_count = 1},
  ...
  {	.manufacturer_name = "_TZ3000_gvn91tmx", .model_name = "TS011F",
    .z2s_device_uid = 11710,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_RELAY_ELECTRICITY_METER_A,
	  .z2s_device_endpoints_count = 1,
    .z2s_device_endpoints = { 
      1, Z2S_REPORTING_SET_FLAG_STANDARD, 
  ...
  {	.manufacturer_name = "_TZ3210_rwmitwj4", .model_name = "TS011F",
    .z2s_device_uid = 11820,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_RELAY_ELECTRICITY_METER_1,
	  .z2s_device_endpoints_count = 1,
    .z2s_device_endpoints = { 
      1, Z2S_REPORTING_SET_FLAG_STANDARD, 
...
{	.manufacturer_name = "_TZ3000_dfgbtub0", .model_name = "TS0042",
  ...
  {	.manufacturer_name = "_TZ3000_fa9mlvja", .model_name = "TS0041",
    .z2s_device_uid = 14050,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_SMART_BUTTON_2F,
	  .z2s_device_endpoints_count = 1},
...
{	.manufacturer_name = "IKEA of Sweden", .model_name = "RODRET wireless dimmer",
  ...
  {	.manufacturer_name = "IKEA of Sweden", .model_name = "SOMRIG shortcut button",
    .z2s_device_uid = 16000,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints =  {{ 1, 0, 0, Z2S_DEVICE_DESC_IKEA_SOMRIG_BUTTON_1 },
  ...
  {	.manufacturer_name = "IKEA of Sweden", .model_name = "VALLHORN Wireless Motion Sensor",
    .z2s_device_uid = 16100,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_IKEA_VALLHORN_1,
	  .z2s_device_endpoints_count = 3,
    .z2s_device_endpoints = { { 1, 0, 0, Z2S_DEVICE_DESC_IKEA_VALLHORN_1 },
                              { 2, 0, 0, Z2S_DEVICE_DESC_IKEA_VALLHORN_2 },
                              { 3, 0, 0, Z2S_DEVICE_DESC_IKEA_VALLHORN_3 }}},
  ...
  {	.manufacturer_name = "Philips", .model_name = "RWL021",
    .z2s_device_uid = 16200,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints =  {{ 1, 0, 0, Z2S_DEVICE_DESC_PHILIPS_HUE_DIMMER_SWITCH_1 },
                              { 2, 0, 0, Z2S_DEVICE_DESC_PHILIPS_HUE_DIMMER_SWITCH_2}}},
  ...
  {	.manufacturer_name = "SONOFF", .model_name = "MINI-ZB2GS-L",
    .z2s_device_uid = 16575,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_RELAY_1,
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {
      { 1, Z2S_REPORTING_SET_FLAG_STANDARD, 
  ...
  {	.manufacturer_name = "_TZ3000_wamqdr3f", .model_name = "TS011F",
    .z2s_device_uid = 16650,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_RELAY_1,
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {{ 11, 0, 0, Z2S_DEVICE_DESC_RELAY_1 },
                             { 1, 0, 0, Z2S_DEVICE_DESC_NULL }}},
...
//ME167
  ...
  {	.manufacturer_name = "_TZ3000_9cpuaca6", .model_name = "TS0505A",
    .z2s_device_uid = 18605,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_RGBW_BULB_MODEL_A,
	  .z2s_device_endpoints_count = 1},
  ...
  {	.manufacturer_name = "_TZ3210_bbu974ki", .model_name = "TS0501B",
 ...
 {	.manufacturer_name = "_TZB210_u3ri0968", .model_name = "TS0505B",
    .z2s_device_uid = 19940,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_RGBW_BULB_MODEL_B,
	  .z2s_device_endpoints_count = 1},
  ...
  {	.manufacturer_name = "GLEDOPTO", .model_name = "GL-C-008P",
    .z2s_device_uid = 20405,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_RGBW_BULB_XY,
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {{ 11, 0, 0, Z2S_DEVICE_DESC_RGBW_BULB_XY },
                             { 1, 0, 0, Z2S_DEVICE_DESC_NULL }}},
  ...
  {	.manufacturer_name = "GLEDOPTO", .model_name = "GL-C-009P",
    .z2s_device_uid = 20407,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_RGBW_BULB_XY,
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {{ 11, 0, 0, Z2S_DEVICE_DESC_RGBW_BULB_XY },
                             { 1, 0, 0, Z2S_DEVICE_DESC_NULL }}},
  
  {	.manufacturer_name = "GLEDOPTO", .model_name = "GL-C-006P",
    .z2s_device_uid = 20408,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_RGBW_BULB_XY,
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {{ 11, 0, 0, Z2S_DEVICE_DESC_RGBW_BULB_XY },
                             { 1, 0, 0, Z2S_DEVICE_DESC_NULL }}},

  {	.manufacturer_name = "GLEDOPTO", .model_name = "GL-C-003P",
    .z2s_device_uid = 20409,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_RGBW_BULB_XY,
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {{ 11, 0, 0, Z2S_DEVICE_DESC_RGBW_BULB_XY },
                             { 1, 0, 0, Z2S_DEVICE_DESC_NULL }}},
...
{	.manufacturer_name = "_TZE204_clrdrnya", .model_name = "TS0601",
    .z2s_device_uid = 24010,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_PRESENCE_SENSOR_RELAY,
	  .z2s_device_endpoints_count = 1},
  ...
  {	.manufacturer_name = "_TZ3000_8kzqqzu4", .model_name = "TS130F",
  ...
  {	.manufacturer_name = "_TZ3000_j1xl73iw", .model_name = "TS130F",
    ...
    .z2s_device_endpoints_count = 2,
	  .z2s_device_endpoints = {{ 1, 0, 0, Z2S_DEVICE_DESC_TUYA_WINDOW_COVERING_SINGLE},
                             { 2, 0, 0, Z2S_DEVICE_DESC_TUYA_WINDOW_COVERING_SINGLE }}},
...
{	.manufacturer_name = "_TZ3000_kmsbwdol", .model_name = "TS130F",
  ...
  {	.manufacturer_name = "_TZ3000_femsaaua", .model_name = "TS130F",
    .z2s_device_uid = 25300,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_LORATAP_WINDOW_COVERING_SINGLE,
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {{ 1, 0, 0, Z2S_DEVICE_DESC_LORATAP_WINDOW_COVERING_SINGLE},
                             { 2, 0, 0, Z2S_DEVICE_DESC_LORATAP_WINDOW_COVERING_SINGLE }}},
  ...
  {	.manufacturer_name = "SILICON_LABORATORIES", .model_name = "NSPanelP-Router",
    .z2s_device_uid = 26425,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_REPEATER,
	  .z2s_device_endpoints_count = 1},
  ...
  {	.manufacturer_name = "LUMI", .model_name = "lumi.remote.cagl02",
    .z2s_device_uid = 26600,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = { { 1, 0, 0, Z2S_DEVICE_DESC_LUMI_CUBE_T1_PRO_1},
                              { 2, 0, 0, Z2S_DEVICE_DESC_LUMI_CUBE_T1_PRO_2 }}},
...
{ .manufacturer_name = "_TZE200_viy9ihs7", .model_name = "TS0601",
  ...
  { .manufacturer_name = "_TZ3210_pagajpog", .model_name = "TS110E",
    ...
    .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_LED_DIMMER_F0,
    .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints ={{ 1, 0, 0, Z2S_DEVICE_DESC_TUYA_LED_DIMMER_F0 },
                            { 2, 0, 0, Z2S_DEVICE_DESC_TUYA_LED_DIMMER_F0 }}},
  ...
  { .manufacturer_name = "_TZE284_kyyu8rbj", .model_name = "TS0601",
    .z2s_device_uid = 35305,
    .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_WATER_LEVEL_SENSOR,
    .z2s_device_endpoints_count = 1},
