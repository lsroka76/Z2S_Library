...
#define SONOFF_SMART_VALVE_CYCLE_SID  0x03
#define SONOFF_SMART_VALVE_TIME_SID   0x04
#define SONOFF_SMART_VALVE_PAUSE_SID  0x05
#define SONOFF_SMART_VALVE_VOLUME_SID 0x06
