...
static const z2s_device_desc_t Z2S_DEVICES_DESC[] PROGMEM [[maybe_unused]] = {
  ...
  { .z2s_device_desc_id = Z2S_DEVICE_DESC_NULL, .z2s_device_clusters_count = 0, .z2s_device_clusters = {0xFFFF}},
...
*/
  ...
  { .z2s_device_desc_id = Z2S_DEVICE_DESC_LUMI_SMART_BUTTON_1F, .z2s_device_clusters_count = 1, .z2s_device_clusters =
    { ESP_ZB_ZCL_CLUSTER_ID_ON_OFF }},
  ...
  { .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_SOS_BUTTON, .z2s_device_clusters_count = 2, .z2s_device_clusters =
    { ESP_ZB_ZCL_CLUSTER_ID_IAS_ZONE,
      TUYA_PRIVATE_CLUSTER_EF00 }},
