...
class Z2S_OnePhaseElectricityMeter : public OnePhaseElectricityMeter {
 public:
  Z2S_OnePhaseElectricityMeter(ZigbeeGateway *gateway, zbg_device_params_t *device, uint64_t *data_counter, bool isTuya, bool active_query = false) : _gateway(gateway), _data_counter(data_counter) {
...
void iterateAlways() override {
  ...
  Supla::Sensor::OnePhaseElectricityMeter::iterateAlways();
