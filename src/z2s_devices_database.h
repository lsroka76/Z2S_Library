...
#define Z2S_DEVICE_DESC_LUMI_RGBCCT_LIGHT_SOURCE            0x3160
...
#define Z2S_DEVICE_DESC_SHELLY_POWER_STRIP_EM               0x4355
...
#define IKEA_CUSTOM_CMD_BILRESA_WHEEL_ROTATE_RIGHT_SID      0x03
#define IKEA_CUSTOM_CMD_BILRESA_WHEEL_ROTATE_LEFT_SID       0x04
...
#define LUMI_SMART_BUTTON_6F_WXKG11LM_PRESSED_SID           0x00
#define LUMI_SMART_BUTTON_6F_WXKG11LM_DOUBLE_PRESSED_SID    0x01
#define LUMI_SMART_BUTTON_6F_WXKG11LM_TRIPLE_PRESSED_SID    0x02
#define LUMI_SMART_BUTTON_6F_WXKG11LM_QUADRUPLE_PRESSED_SID 0x04
#define LUMI_SMART_BUTTON_6F_WXKG11LM_HELD_SID              0x05
#define LUMI_SMART_BUTTON_6F_WXKG11LM_RELEASED_SID          0x06
...
#define Z2S_REPORTING_SET_DESC_SHELLY_POWER_STRIP_EM                    0x0410
...
static const z2s_reporting_set_desc_t Z2S_REPORTING_SETS_DESC[] PROGMEM [[maybe_unused]] = {
  ...
  { .z2s_reporting_set_id = Z2S_REPORTING_SET_DESC_SHELLY_POWER_STRIP_EM,
    .z2s_cluster_id = ESP_ZB_ZCL_CLUSTER_ID_ELECTRICAL_MEASUREMENT,
    .z2s_attribute_id = ESP_ZB_ZCL_ATTR_ELECTRICAL_MEASUREMENT_AC_FREQUENCY_ID,
    .z2s_attribute_type = ESP_ZB_ZCL_ATTR_TYPE_U16,
    .z2s_min_interval_value = 5, 
    .z2s_max_interval_value = 3600,
    .z2s_delta_value = 125,
...
static const z2s_device_desc_t Z2S_DEVICES_DESC[] PROGMEM [[maybe_unused]] = {
  ...
  {	.z2s_device_desc_id = Z2S_DEVICE_DESC_TS0601_ZWT_ZWT198,
    .z2s_device_clusters_count = 2,
    .z2s_device_config_flags = 0, //Z2S_DEVICE_DESC_CONFIG_FLAG_TUYA_FORCE_TIME_SYNC, 
  ...
  {	.z2s_device_desc_id = Z2S_DEVICE_DESC_LUMI_RGBCCT_LIGHT_SOURCE,
    .z2s_device_clusters_count = 3,
    .z2s_device_config_flags = Z2S_DEVICE_DESC_CONFIG_FLAG_LUMI_INIT,
    .z2s_device_clusters = { 
      ESP_ZB_ZCL_CLUSTER_ID_ON_OFF,
...
static const z2s_device_endpoint_t 
  SHELLY_RELAY_ELECTRICITY_METER_ENDPOINTS[] PROGMEM = {
  ...
  { 0x02, Z2S_REPORTING_SET_FLAG_STANDARD, 
    Z2S_REPORTING_SET_DESC_SHELLY_POWER_STRIP_EM, 
    Z2S_DEVICE_DESC_SHELLY_RELAY_ELECTRICITY_METER },
  { 0x03, Z2S_REPORTING_SET_FLAG_STANDARD, 
    Z2S_REPORTING_SET_DESC_SHELLY_POWER_STRIP_EM, 
    Z2S_DEVICE_DESC_SHELLY_RELAY_ELECTRICITY_METER },
...
//DEVICES_START
  ...
  {	.manufacturer_name = "_TZE200_yjjdcqsq", .model_name = "TS0601",
    .z2s_device_uid = 910,
	.z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_TEMPHUMIDITY_EF00_SENSOR,
	.z2s_device_endpoints_count = 1},

  {	.manufacturer_name = "_TZE204_yjjdcqsq", .model_name = "TS0601",
    .z2s_device_uid = 915,
	.z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_TEMPHUMIDITY_EF00_SENSOR,
	.z2s_device_endpoints_count = 1},

  {	.manufacturer_name = "_TZE284_yjjdcqsq", .model_name = "TS0601",
    .z2s_device_uid = 920,
	.z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_TEMPHUMIDITY_EF00_SENSOR,
	.z2s_device_endpoints_count = 1},
  ...
  {	.manufacturer_name = "SONOFF", .model_name = "SNZB-02B",
    .z2s_device_uid = 2005,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TEMPHUMIDITY_SENSOR_POLL,
	  .z2s_device_endpoints_count = 1
  },
  ...
  {	.manufacturer_name = "LUMI", .model_name = "lumi.sensor_ht.agl02",
    .z2s_device_uid = 2910,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_LUMI_TEMPHUMIPRESSURE_SENSOR_2,
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {
      { 1, 0, 0, Z2S_DEVICE_DESC_LUMI_TEMPHUMIPRESSURE_SENSOR },
 ...
 {	.manufacturer_name = "_TZE284_sgabhwa6", .model_name = "TS0601",
  ...
  {	.manufacturer_name = "_TZ3000_mcxw5ehu", .model_name = "TS0202",
   .z2s_device_uid = 3900,
    ...
    .z2s_device_endpoints = { 
      1, Z2S_REPORTING_SET_FLAG_STANDARD, 
      Z2S_REPORTING_SET_DESC_BATTERY_PERCENTAGE_REPORTING_STANDARD, 
      Z2S_DEVICE_DESC_TUYA_IAS_ZONE_1_B_SENSOR}},
  ...
  {	.manufacturer_name = "IKEA of Sweden", .model_name = "PARASOLL Door/Window Sensor",
    .z2s_device_uid = 5600,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {
      { 1, 0, 0, Z2S_DEVICE_DESC_IKEA_IAS_ZONE_SENSOR_1},
 ...
 {	.manufacturer_name = "HOBEIAN", .model_name = "ZG-223Z",
  ...
  {	.manufacturer_name = "_TZ3040_6ygjfyll", .model_name = "TS0202",
    .z2s_device_uid = 8205,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_IAS_ZONE_1_B_SENSOR,
	  .z2s_device_endpoints_count = 1,
    .z2s_device_endpoints = { 
  ...
  {	.manufacturer_name = "_TZ3000_msl6wxk9", .model_name = "TS0202",
    .z2s_device_uid = 8210,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_IAS_ZONE_1_B_SENSOR,
	  .z2s_device_endpoints_count = 1,
    .z2s_device_endpoints = { 
  ...
  {	.manufacturer_name = "Develco Products A/S", .model_name = "WISZB-120",
    .z2s_device_uid = 9300,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {
      { 35, 0, 0, Z2S_DEVICE_DESC_IAS_ZONE_SENSOR_1_T_B },
  ...
  {	.manufacturer_name = "Develco Products A/S", .model_name = "SPLZB-132",
    .z2s_device_uid = 9400,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {
      { 2, 0, 0, Z2S_DEVICE_DESC_DEVELCO_RELAY_ELECTRICITY_METER },
  ...
  {	.manufacturer_name = "Develco Products A/S", .model_name = "AQSZB-110",
   .z2s_device_uid = 9500,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {
      { 38, 0, 0, Z2S_DEVICE_DESC_DEVELCO_AIR_QUALITY_SENSOR },
      { 1, 0, 0, Z2S_DEVICE_DESC_NULL }}},
  ...
  {	.manufacturer_name = "_TZ3000_abjodzas", .model_name = "TS0011",
    .z2s_device_uid = 11020,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_ON_OFF_VALVE_DC,
	  .z2s_device_endpoints_count = 1},
  ...
  {	.manufacturer_name = "LUMI", .model_name = "lumi.switch.l2aeu1",
    .z2s_device_uid = 11205,
	  ...
	  .z2s_device_endpoints_count = 2,
     .z2s_device_endpoints = {
      { 1, 0, 0, Z2S_DEVICE_DESC_LUMI_DOUBLE_SWITCH },
...
{	.manufacturer_name = "_TZ3000_dfgbtub0", .model_name = "TS0042",
  ...
  {	.manufacturer_name = "_TZ3000_6km7djcm", .model_name = "",
    .z2s_device_uid = 14815,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_SMART_BUTTON_3F,
	  .z2s_device_endpoints_count = 1},
...
{	.manufacturer_name = "IKEA of Sweden", .model_name = "RODRET wireless dimmer",
  ...
  {	.manufacturer_name = "IKEA of Sweden", .model_name = "VALLHORN Wireless Motion Sensor",
    .z2s_device_uid = 16100,
	  ...
	  .z2s_device_endpoints_count = 3,
    .z2s_device_endpoints = { 
      { 1, 0, 0, Z2S_DEVICE_DESC_IKEA_VALLHORN_1 },
  ...
  {	.manufacturer_name = "Philips", .model_name = "RWL021",
    .z2s_device_uid = 16200,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints =  {
      { 1, 0, 0, Z2S_DEVICE_DESC_PHILIPS_HUE_DIMMER_SWITCH_1 },
  ...
  {	.manufacturer_name = "_TZ3000_wamqdr3f", .model_name = "TS011F",
    .z2s_device_uid = 16650,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {
      { 11, 0, 0, Z2S_DEVICE_DESC_RELAY_1 },
      { 1, 0, 0, Z2S_DEVICE_DESC_NULL }}},
...
//ME167
  ...
  {	.manufacturer_name = "_TZB210_rs0ufzwg", .model_name = "TS0505B",
    .z2s_device_uid = 19915,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_RGBCCT_LIGHT_SOURCE,//Z2S_DEVICE_DESC_TUYA_RGBW_BULB_MODEL_B,
	  .z2s_device_endpoints_count = 1},
 ...
 {	.manufacturer_name = "_TZB210_u3ri0968", .model_name = "TS0505B",
  ...
  {	.manufacturer_name = "GLEDOPTO", .model_name = "GL-C-007P",
    .z2s_device_uid = 20406,
	  .z2s_device_desc_id = 
      Z2S_DEVICE_DESC_DIMMER_CT_LIGHT_SOURCE,
      //Z2S_DEVICE_DESC_RGBW_BULB_XY,
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {
      { 11, 0, 0, 
  ...
  {	.manufacturer_name = "_TZ3210_imaccztn", .model_name = "TS0004",
    .z2s_device_uid = 22405,
	  .z2s_device_desc_id = Z2S_DEVICE_DESC_TUYA_4GANG_SWITCH,
    .z2s_device_flags = Z2S_DEVICE_CONFIG_FLAG_MIRROR_ALL_ENDPOINTS,
	  .z2s_device_endpoints_count = 4,
    .z2s_device_endpoints = {{ 1, 0, 0, Z2S_DEVICE_DESC_TUYA_GANG_SWITCH_1}}},
  ...
  {	.manufacturer_name = "_TZ3000_h1ipgkwn", .model_name = "TS0002",
    .z2s_device_uid = 22500,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = { 
      { 1, 0, 0, Z2S_DEVICE_DESC_TUYA_RELAY },
...
{	.manufacturer_name = "_TZE204_clrdrnya", .model_name = "TS0601",
  ...
  /*{	.manufacturer_name = "TELINK", .model_name = "TLSR82xx",
    .z2s_device_uid = 24305,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = { 
      { 1, 0, 0, Z2S_DEVICE_DESC_SMART_BUTTON_2F },
  ...
  {	.manufacturer_name = "_TZ3000_j1xl73iw", .model_name = "TS130F",
    ...
    .z2s_device_endpoints_count = 2,
	  .z2s_device_endpoints = {
      { 1, 0, 0, Z2S_DEVICE_DESC_TUYA_WINDOW_COVERING_SINGLE},
...
{	.manufacturer_name = "_TZ3000_kmsbwdol", .model_name = "TS130F",
  ...
  {	.manufacturer_name = "_TZ3000_femsaaua", .model_name = "TS130F",
    .z2s_device_uid = 25300,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {
      { 1, 0, 0, Z2S_DEVICE_DESC_LORATAP_WINDOW_COVERING_SINGLE},
  ...
  {	.manufacturer_name = "LUMI", .model_name = "lumi.remote.cagl02",
    .z2s_device_uid = 26600,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = { 
      { 1, 0, 0, Z2S_DEVICE_DESC_LUMI_CUBE_T1_PRO_1},
...
{ .manufacturer_name = "_TZE200_viy9ihs7", .model_name = "TS0601",
  ...
  { .manufacturer_name = "_TZ3210_pagajpog", .model_name = "TS110E",
    ...
    .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints ={
      { 1, 0, 0, Z2S_DEVICE_DESC_TUYA_LED_DIMMER_F0 },
  ...
  {	.manufacturer_name = "Shelly", .model_name = "2PM",
    .z2s_device_uid = 32900,
	  ...
	  .z2s_device_endpoints_count = 2,
    .z2s_device_endpoints = {
      { 1, 0, 0, Z2S_DEVICE_DESC_SHELLY_RELAY_ELECTRICITY_METER },
      { 2, 0, 0, Z2S_DEVICE_DESC_SHELLY_RELAY_ELECTRICITY_METER }}},

    {	.manufacturer_name = "Shelly", .model_name = "Power Strip",
 ...
 { .manufacturer_name = "_TZE608_c75zqghm", .model_name = "TS0603",
  ...
  { .manufacturer_name = "Aqara", .model_name = "lumi.light.agl003",
    .z2s_device_uid = 36700,
    .z2s_device_desc_id = Z2S_DEVICE_DESC_LUMI_RGBCCT_LIGHT_SOURCE,
    .z2s_device_endpoints_count = 1},

  { .manufacturer_name = "", .model_name = "lumi.light.agl003",
    .z2s_device_uid = 36705,
    .z2s_device_desc_id = Z2S_DEVICE_DESC_LUMI_RGBCCT_LIGHT_SOURCE,
    .z2s_device_endpoints_count = 1},
