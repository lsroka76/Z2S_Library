...
#define SONOFF_CUSTOM_CLUSTER_FROST_PROTECTION_TEMPERATURE_ID 0x6002 //S16
#define SONOFF_CUSTOM_CLUSTER_IDLE_STEPS_ID                   0x6003 //U16
#define SONOFF_CUSTOM_CLUSTER_CLOSING_STEPS_ID                0x6004 //U16
#define SONOFF_CUSTOM_CLUSTER_VALVE_OPENING_LIMIT_VOLTAGE     0x6005 //U16
#define SONOFF_CUSTOM_CLUSTER_VALVE_CLOSING_LIMIT_VOLTAGE     0x6006 //U16
#define SONOFF_CUSTOM_CLUSTER_VALVE_MOTOR_RUNNING_VOLTAGE     0x6007 //U16
#define SONOFF_CUSTOM_CLUSTER_VALVE_OPENING_DEGREE            0x600B //U8
...
#define SONOFF_CUSTOM_CLUSTER_TEMPERATURE_ACCURACY            0x6011 //S16
#define SONOFF_CUSTOM_CLUSTER_TRVZB_PID_MODE                  0x6017 //8BITMAP
/*SNZB-04P attributes*/
#define SONOFF_CUSTOM_CLUSTER_TAMPER_ID                       0x2000 //U8
/*SNZB-03P attributes*/
#define SONOFF_CUSTOM_CLUSTER_ILLUMINATION_ID                 0x2001 //U8
/*SWV attributes*/
#define SONOFF_CUSTOM_CLUSTER_RT_IRRIGATION_DURATION_ID       0x5006 //U32
#define SONOFF_CUSTOM_CLUSTER_RT_IRRIGATION_VOLUME_ID         0x5007 //U32
...
/*EM attributes*/
#define SONOFF_CUSTOM_CLUSTER_AC_CURRENT_ID                   0x7004 //UINT32
#define SONOFF_CUSTOM_CLUSTER_AC_VOLTAGE_ID                   0x7005 //UINT32
#define SONOFF_CUSTOM_CLUSTER_AC_POWER_ID                     0x7006 //UINT32
#define SONOFF_CUSTOM_CLUSTER_AC_ENERGY_TODAY_ID              0x7009 //UINT32
#define SONOFF_CUSTOM_CLUSTER_AC_ENERGY_MONTH_ID              0x700A //UINT32
#define SONOFF_CUSTOM_CLUSTER_AC_ENERGY_YESTERDAY_ID          0x700B //UINT32
#define SONOFF_CUSTOM_CLUSTER_OUTLET_CONTROL_PROTECT_ID       0x7007 //U8
/*ZBMINIR2*/
#define SONOFF_CUSTOM_CLUSTER_TURBO_MODE_ID                   0x0012 //S16
/*SNZB-02LD, SNZB-02WD, SNZB-02P*/
...
#define LUMI_CUSTOM_CURTAIN_CALIBRATION_CMD_ID                0x0407 //U8
#define LUMI_CUSTOM_CURTAIN_POSITION_ID                       0x041F //U8
#define LUMI_CUSTOM_CURTAIN_CURRENT_STATUS_ID                 0x0421 //U8
...
#define DEVELCO_CUSTOM_CLUSTER_MEASURED_VALUE_ID              0x0000
...
public:
  ...
  void onAnalogInputReceive(void (*callback)(uint16_t short_addr, uint16_t, uint16_t, 
                            const esp_zb_zcl_attribute_t *)) {
    _on_analog_input_receive = callback;
  }
  void onMeteringReceive(void (*callback)(uint16_t short_addr, uint16_t, uint16_t, 
                         const esp_zb_zcl_attribute_t *)) {
    _on_metering_receive = callback;
  }
  void onBasicReceive(
    void (*callback)(uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *)) {
    _on_basic_receive = callback;
  }
  void onCurrentSummationReceive(void (*callback)(uint16_t short_addr, uint16_t, uint16_t, uint64_t)) {
  ...
  void onIkeaCustomClusterReceive(
    void (*callback)(uint16_t short_addr, uint16_t endpoint_id, 
    uint16_t cluster_id, const esp_zb_zcl_attribute_t *)) {

    _on_ikea_custom_cluster_receive = callback;
  }

  /*
  void onTemperatureReceive(
    void (*callback)(uint16_t short_addr, uint16_t, uint16_t,
    const esp_zb_zcl_attribute_t *)) {
      _on_temperature_receive = callback;
}

  void onHumidityReceive(
    void (*callback)(uint16_t short_addr, uint16_t, uint16_t,
    const esp_zb_zcl_attribute_t *)) {
      _on_humidity_receive = callback;
  }

  void onPressureReceive(
    void (*callback)(uint16_t short_addr, uint16_t, uint16_t,
    const esp_zb_zcl_attribute_t *)) {
      _on_pressure_receive = callback;
  }

  void onConcentrationReceive(
    void (*callback)(uint16_t short_addr, uint16_t, uint16_t,
    const esp_zb_zcl_attribute_t *)) {
      _on_concentration_receive = callback;
  }
  ...
  void onCurrentLevelReceive(
    void (*callback)(uint16_t short_addr, uint16_t, uint16_t,
    const esp_zb_zcl_attribute_t *)) {
      _on_current_level_receive = callback;
  }

  void onColorControlReceive(
    void (*callback)(uint16_t short_addr, uint16_t, uint16_t,
    const esp_zb_zcl_attribute_t *)) {
      _on_color_control_receive = callback;
  }

  void onThermostatReceive(
    void (*callback)(uint16_t short_addr, uint16_t, uint16_t,
    const esp_zb_zcl_attribute_t *)) {
      _on_thermostat_receive = callback;
  }

  void onThermostatUIReceive(
    void (*callback)(uint16_t short_addr, uint16_t, uint16_t,
    const esp_zb_zcl_attribute_t *)) {
...
void (*_on_temperature_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_humidity_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_pressure_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_concentration_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_illuminance_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_flow_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_occupancy_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);
...
void (*_on_binary_input_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_multistate_input_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_analog_input_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_metering_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_basic_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_current_summation_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_battery_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_current_level_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_color_control_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_thermostat_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_thermostat_ui_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_door_lock_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);

void (*_on_window_covering_receive)(
  uint16_t short_addr, uint16_t, uint16_t, const esp_zb_zcl_attribute_t *);
  */
