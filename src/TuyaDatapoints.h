...
#define TUYA_PRESENCE_SENSOR_ZG205ZA_PRESENCE_DP                    0x01
#define TUYA_PRESENCE_SENSOR_ZG205ZA_LM_DETECTION_SENSITIVITY_DP    0x02
#define TUYA_PRESENCE_SENSOR_ZG205ZA_LM_DETECTION_DISTANCE_DP       0x04
#define TUYA_PRESENCE_SENSOR_ZG205ZA_MOTION_STATE_DP                0x65
#define TUYA_PRESENCE_SENSOR_ZG205ZA_FADING_TIME_DP                 0x66
#define TUYA_PRESENCE_SENSOR_ZG205ZA_MM_DETECTION_DISTANCE_DP       0x68
#define TUYA_PRESENCE_SENSOR_ZG205ZA_MM_DETECTION_SENSITIVITY_DP    0x69
#define TUYA_PRESENCE_SENSOR_ZG205ZA_ILLUMINANCE_DP                 0x6A
#define TUYA_PRESENCE_SENSOR_ZG205ZA_INDICATOR_DP                   0x6B
#define TUYA_PRESENCE_SENSOR_ZG205ZA_SM_DETECTION_DISTANCE_DP       0x6C
#define TUYA_PRESENCE_SENSOR_ZG205ZA_SM_DETECTION_SENSITIVITY_DP    0x6D
#define TUYA_PRESENCE_SENSOR_ZG205ZA_TARGET_DISTANCE_DP             0x7A
#define TUYA_PRESENCE_SENSOR_ZG205ZA_MINIMUM_RANGE_DP               0x7B
...
#define TUYA_PRESENCE_SENSOR_ZG204ZK_PRESENCE_DP                    0x01
#define TUYA_PRESENCE_SENSOR_ZG204ZK_SD_SENSITIVITY_DP              0x02
#define TUYA_PRESENCE_SENSOR_ZG204ZK_DETECTION_DISTANCE_DP          0x04
#define TUYA_PRESENCE_SENSOR_ZG204ZK_FADING_TIME_DP                 0x66
#define TUYA_PRESENCE_SENSOR_ZG204ZK_LED_INDICATOR_MODE_DP          0x6B
#define TUYA_PRESENCE_SENSOR_ZG204ZK_BATTERY_DP                     0x79
#define TUYA_PRESENCE_SENSOR_ZG204ZK_ANTI_INTERFERENCE_DP           0x7A
#define TUYA_PRESENCE_SENSOR_ZG204ZK_MD_SENSITIVITY_DP              0x7B


#define TUYA_PRESENCE_SENSOR_ZG104PLV_PRESENCE_DP                   0x01
#define TUYA_PRESENCE_SENSOR_ZG104PLV_VIBRATION_DP                  0x03
#define TUYA_PRESENCE_SENSOR_ZG104PLV_BATTERY_DP                    0x04
#define TUYA_PRESENCE_SENSOR_ZG104PLV_VIBRATION_SENSITIVITY_DP      0x06
#define TUYA_PRESENCE_SENSOR_ZG104PLV_ILLUMINANCE_DP                0x14
#define TUYA_PRESENCE_SENSOR_ZG104PLV_SAMPLING_INTERVAL_DP          0x65
#define TUYA_PRESENCE_SENSOR_ZG104PLV_ILLUMINANCE_V0_DP             0x68
#define TUYA_PRESENCE_SENSOR_ZG104PLV_ILLUMINANCE_V1_DP             0x69
#define TUYA_PRESENCE_SENSOR_ZG104PLV_ILLUMINANCE_CALIBRATION_DP    0x6A
#define TUYA_PRESENCE_SENSOR_ZG104PLV_ILLUMINANCE_WARNING_DP        0x6B
...
#define TUYA_PRESENCE_SENSOR_SZLR08T_PRESENCE_DP                    0x01
#define TUYA_PRESENCE_SENSOR_SZLR08T_DETECTION_RANGE_DP             0x0D
#define TUYA_PRESENCE_SENSOR_SZLR08T_RADAR_SENSITIVITY_DP           0x10
#define TUYA_PRESENCE_SENSOR_SZLR08T_ILLUMINANCE_DP                 0x14
#define TUYA_PRESENCE_SENSOR_SZLR08T_LED_INDICATOR_DP               0x65
#define TUYA_PRESENCE_SENSOR_SZLR08T_RADAR_SWITCH_DP                0x66
#define TUYA_PRESENCE_SENSOR_SZLR08T_FADING_TIME_DP                 0x67
#define TUYA_PRESENCE_SENSOR_SZLR08T_RELAY_SWITCH_DP                0x68
#define TUYA_PRESENCE_SENSOR_SZLR08T_RELAY_MODE_DP                  0x6A
#define TUYA_PRESENCE_SENSOR_SZLR08T_RADAR_MODE_DP                  0x6B
...
#define TUYA_WATER_QUALITY_MONITOR_PROBE_TEMPERATURE_DP             0x01// /10
#define TUYA_WATER_QUALITY_MONITOR_BATTERY_LEVEL_DP                 0x04
#define TUYA_WATER_QUALITY_MONITOR_TEMPERATURE_DP                   0x05// /100
#define TUYA_WATER_QUALITY_MONITOR_SAMPLING_INTERVAL_DP             0x65
#define TUYA_WATER_QUALITY_MONITOR_PROBE_TEMPERATURE_CALIBRATION_DP 0x6C 
#define TUYA_WATER_QUALITY_MONITOR_TEMPERATURE_CALIBRATION_DP       0x72
#define TUYA_WATER_QUALITY_MONITOR_HUMIDITY_DP                      0x76 
#define TUYA_WATER_QUALITY_MONITOR_HUMIDITY_CALIBRATION_DP          0x77 
#define TUYA_WATER_QUALITY_MONITOR_TDS_DP                           0x7C
#define TUYA_WATER_QUALITY_MONITOR_EC_DP                            0x7F
#define TUYA_WATER_QUALITY_MONITOR_SALINITY_DP                      0x83// /10
#define TUYA_WATER_QUALITY_MONITOR_SG_DP                            0x84// /1000
#define TUYA_WATER_QUALITY_MONITOR_MODE_DP                          0x85
